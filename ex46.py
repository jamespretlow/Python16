...
Award time-and-a-half for the hourly rate for all hours worked above 40 hours. Put the logic to do the computation of time-and-a-half in a function called computepay()
...
#prompt the user for hours and rate per hour using raw_input to compute gross pay
    hours = float(raw_input("What are your hours?"))
    rate = float(raw_input ("What is your pay rate?"))


#Award time-and-a-half for the hourly rate for all hours worked above 40 hours.
    if hours > 40:
        otpay = (40 * rate) + ((hours-40) * (rate *1.5))
        return otpay
        print otpay
